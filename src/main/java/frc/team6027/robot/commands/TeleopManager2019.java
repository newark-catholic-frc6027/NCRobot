...
*/
    ...
    public TeleopManager2019(OperatorInterface operatorInterface, SensorService2019 sensorService,
            DrivetrainSubsystem2019 drivetrain, OperatorDisplay operatorDisplay) {
...
//        VisionTurnCommand cmd = new VisionTurnCommand();
//        double angleToTurn = cmd.calculateAngle();

//        this.yButton.whenPressed(new VisionTurnCommand(angleToTurn,  this.sensorService, this.drivetrain,
//           this.operatorDisplay));
 //       this.yButton.whenPressed(new VisionTurnCommand());
