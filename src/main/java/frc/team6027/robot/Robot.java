...
import frc.team6027.robot.commands.TeleopManager2019;
/*
...
import frc.team6027.robot.sensors.SensorService2019;
import frc.team6027.robot.subsystems.DrivetrainSubsystem2019;
//import frc.team6027.robot.subsystems.ElevatorSubsystem2019;
import frc.team6027.robot.subsystems.PneumaticSubsystem2019;
...
public class Robot extends TimedRobot {
    ...
    private DrivetrainSubsystem2019 drivetrain;
    /*
    private PneumaticSubsystem pneumaticSubsystem;
    private ElevatorSubsystem elevatorSubsystem;
    */
    private SensorService2019 sensorService;
    ...
    */
    ...
    public void robotInit() {
        ...
        this.setSensorService(new SensorService2019());
        ...
        this.setDrivetrain(new DrivetrainSubsystem2019(this.getOperatorInterface()));
...
//        this.setPneumaticSubsystem(new PneumaticSubsystem(this.getOperatorDisplay()));
        ...
        // autonomous mode
        TeleopManager2019 teleOpCommand = new TeleopManager2019(this.operatorInterface, this.sensorService,
                this.getDrivetrain(), this.operatorDisplay);
...
//        this.getOperatorDisplay().setFieldValue("blobResult", this.blobResultEntry.getDouble(-8888.88));
    ...
    public DrivetrainSubsystem2019 getDrivetrain() {
        return drivetrain;
    }

    public void setDrivetrain(DrivetrainSubsystem2019 drivetrain) {
...
*/
    ...
    public SensorService2019 getSensorService() {
        return sensorService;
    }

    public void setSensorService(SensorService2019 sensorService) {
